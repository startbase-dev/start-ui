...
<Tabs items={['Preview', 'Code', 'React Hook Form']}>
  ...
  <Tabs.Tab>
    ...
    <Controller
      name="input"
      control={control}
      render={({ field }) => <PhoneInput value={watch('input')} {...field} />}
    />
    ```
  </Tabs.Tab>
</Tabs>
...
This component is a wrapper around [react-international-phone](https://www.npmjs.com/package/react-international-phone) component.
