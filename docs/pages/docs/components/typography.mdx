  ...
  <Tabs.Tab>
    <Preview height={200}>
      <Typography
        ...
        color="success"
        gradient
        children="Open-Source UI Library for Customizable, Modern, and Accessible Web
        Interfaces"
      />
    </Preview>
  </Tabs.Tab>
  ...
  <Tabs.Tab>
    <Preview height={500} width={500}>
      <Typography
        variant="paragraph"
        size="lead"
        children="StartUI is an open-source UI library designed to make web development
